...
<div id="coca12"> <body><br>
  ...
  <body>
    <form name="MyForm"><P >
     ...
     <div><input type="button" value="Calcular" onclick="ca()"><input type="reset" value="Eliminar">
        </div> 
        <br>
  </form>
  ...
  <body>
    <form name="MyForm2"><P>
     ...
     <div><input type="button" value="Calcular" onclick="Mg()"><input type="reset" value="Eliminar"></div>
  ...
  <script>
    ...
    <form name="MyForm3"><P >
     ...
     <div><input type="button" value="Calcular" onclick="so()"><input type="reset" value="Eliminar">
      </div>   
  </form>
<br>
  <script>
    ...
    <form name="MyForm4"><P >
     ...
     <div><input type="button" value="Calcular" onclick="POTA()"><input type="reset" value="Eliminar">
         </div>
  </form>
<br>
  <script>
...
<div id="coca121"> 
  ...
  <body>
    <form name="MyForm5"><P >
     ...
     <div><input type="button" value="Calcular" onclick="fa()"><input type="reset" value="Eliminar">
         </div>
  </form>
