...
<div id="coca">
  <div style="text-align:center;">
    <h3 style="font-family:'Times New Roman';">Calcular tres bolillos hilera sencilla</h3>
    <img src="tress.png" alt="Método tres bolillos" height="190px" style="margin-bottom: 15px;">
  </div>
  ...
  <form name="MyForm" style="font-family:'Times New Roman'; color:#424949; padding: 10px;">
    ...
    <label><strong>Distancia entre plantas (m):</strong></label><br>
