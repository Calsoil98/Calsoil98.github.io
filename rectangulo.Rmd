...
<div id="coca">
  <div style="text-align:center;">
    <h3 style="font-family:'Times New Roman';">Calcular rectángulo</h3>
    <img src="rect.png" alt="Método rectángulo" height="190px" style="margin-bottom: 15px;">
  </div>

  <form name="MyForme" style="font-family:'Times New Roman'; color:#424949; padding: 10px;">
    ...
    <div style="text-align:center;">
      <input type="button" value="Calcular" onclick="rec()">
